...
object_Ground.getVerticlPosition = function(i,l,posi) {
	...
	if(l > 0) {
		...
		leftPosi = jp_okawa_utils_MathTools.randomFloat(leftY - 6,leftY + 6);
	}
	if(i > 0) {
		var frontY = object_Ground._particlePositions[posi - 300 + 1];
		frontPosi = jp_okawa_utils_MathTools.randomFloat(frontY - 6,frontY + 6);
	}
	if(frontPosi == null) {
		frontPosi = leftPosi;
	}
...
object_Ground.VERTICAL_INTERVAL = 6;
