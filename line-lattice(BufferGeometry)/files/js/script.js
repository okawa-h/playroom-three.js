...
object_Ground.setParticleObject = function() {
	...
	while(_g1 < _g) {
		...
		while(_g31 < _g21) {
			...
			var x01 = (j1 - N / 2) * w;
			var y01 = (i - N / 2) * w;
			var z01 = getZ(x01,y01);
			var x11 = (j1 - N / 2) * w;
			var y11 = (i + 1 - N / 2) * w;
			var z11 = getZ(x11,y11);
			geometry.vertices.push(new THREE.Vector3(x01,y01,z01));
			geometry.vertices.push(new THREE.Vector3(x11,y11,z11));
		}
	}
	var material = new THREE.LineBasicMaterial({ color : 16777215, transparent : true, opacity : 0.5});
	var lines = new THREE.LineSegments(geometry,material);
	utils_SceneManager.add(lines);
