...
object_Viewer.onUpdate = function() {
	...
	var pixels2 = object_Viewer._ctx.getImageData(0,0,width,height).data;
	...
	while(_g1 < _g) {
		...
		while(_g3 < _g2) {
			...
			index = i * 4 + l * (4 * width);
			var total = pixels2[index] + pixels2[index + 1] + pixels2[index + 2];
			if(r + g + b > 1) {
				continue;
			}
			var x = (i - width * .5) * 5;
			...
			object_Viewer._particlePositions[posi++] = total;
			++length;
		}
	}
