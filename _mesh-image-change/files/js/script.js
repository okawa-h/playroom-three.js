...
object_Viewer.create = function() {
	...
	object_Viewer.createMeshs(64,64);
	object_ViewerGroup.add(object_Viewer._parent);
};
object_Viewer.onUpdate = function() {
};
object_Viewer.createMeshs = function(width,height) {
	var data = utils_MaterialManager.get("raichu");
	var pixels = data.pixelData;
	var pixelCounter = 0;
	var halfW = width * .5;
	var halfH = height * .5;
	var _g1 = 0;
	...
	while(_g1 < _g) {
		...
		while(_g3 < _g2) {
			...
			TweenMax.to(mesh.position,1,{ x : (i - halfW) * 10, y : -(l - halfH) * 10, z : jp_okawa_utils_MathTools.randomFloatSpread(0), ease : Expo.easeInOut, onComplete : function() {
			}});
		}
	}
};
...
utils_MaterialManager._orderList = [{ id : "raichu", src : "files/img/raichu.png", type : "image"},{ id : "pikachu", src : "files/img/pikachu.png", type : "image"}];
view_Camera.FOV = 60;
view_Camera.NEAR = 1;
