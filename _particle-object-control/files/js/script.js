...
utils_OrbitControlsManager.init = function() {
	var canvas = utils_RendererManager.getElement();
	utils_OrbitControlsManager._parent = new THREE.OrbitControls(view_Camera.getParent(),canvas);
};
...
view_ObjectManager.add = function(object) {
	utils_SceneManager.add(object);
};
...
view_object_Particle.create = function() {
	var geometry = new THREE.CircleGeometry(5,20);
	var material = new THREE.MeshBasicMaterial({ color : 16777215});
	view_object_Particle._object = new THREE.Mesh(geometry,material);
