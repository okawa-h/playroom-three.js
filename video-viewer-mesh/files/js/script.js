...
object_Viewer.create = function() {
	...
	object_Viewer.createMesh(object_Viewer._video.videoWidth / 20,object_Viewer._video.videoHeight / 10);
...
object_Viewer.createMesh = function(xsize,ysize) {
	...
	while(_g < 20) {
		...
		while(_g1 < 10) {
			...
			var material = new THREE.MeshLambertMaterial({ color : 16777215, map : object_Viewer._texture});
			object_Viewer._materials[cubeCounter] = material;
			var mesh = new THREE.Mesh(geometry,material);
			mesh.position.x = (i - 10.) * xsize;
			mesh.position.y = (l - 5.) * ysize;
			mesh.position.z = 0;
			object_Viewer._parent.add(mesh);
			++cubeCounter;
			TweenMax.to(mesh.position,1,{ z : jp_okawa_utils_MathTools.randomFloatSpread(200), ease : Expo.easeInOut, repeat : -1, yoyo : true});
		}
	}
};
...
object_Viewer.X_GRID = 20;
object_Viewer.Y_GRID = 10;
